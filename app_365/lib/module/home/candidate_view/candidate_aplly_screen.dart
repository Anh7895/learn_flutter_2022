...
class CandidateApplyScreen extends StatefulWidget {
  const CandidateApplyScreen({Key? key}) : super(key: key);

  @override
  State<CandidateApplyScreen> createState() => _CandidateApplyScreenState();
}

class _CandidateApplyScreenState extends State<CandidateApplyScreen> {
  DropListModel listSex = DropListModel(
    [
      OptionItem(id: "1", title: "Không đạt yêu cầu"),
  ...
  OptionItem itemSex = OptionItem(id: null, title: "Trạng thái");
