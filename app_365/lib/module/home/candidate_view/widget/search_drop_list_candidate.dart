...
class SelectDropListCandidate extends StatefulWidget {
  final OptionItem itemSelected;
  final DropListModel dropListModel;
  final Function(OptionItem optionItem) onOptionSelected;

  SelectDropListCandidate(
      this.itemSelected,
      this.dropListModel,
  ...
  @override
  _SelectDropListCandidateState createState() => _SelectDropListCandidateState(
    itemSelected,
    dropListModel,
  );
}

class _SelectDropListCandidateState extends State<SelectDropListCandidate> with SingleTickerProviderStateMixin {
  ...
  _SelectDropListCandidateState(this.optionItemSelected, this.dropListModel);
